...
class WeekClass:
    def __init__(self, foodEvents=[
        ...
        "1 adag = 1 db péksütemény (pl. kifli vagy zsemle) vagy 1 közepes szelet kenyér/kalács vagy 12 evőkanál (20 dkg:3) főtt tészta/rizs vagy 3 evőkanál gabonapehely/müzli",
        ...
        "pl. diót, mandulát, mogyorót, tökmagot, napraforgómagot."]):
        self.weekyear = year
